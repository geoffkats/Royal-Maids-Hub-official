<div class="p-6">
    ...
    <div class="mb-6">
        ...
        <h2 class="text-2xl font-bold text-zinc-900 dark:text-white">Edit Package: {{ $package->name }}</h2>
        <p class="text-sm text-zinc-600 dark:text-zinc-400 mt-1">Update package details, pricing and features</p>
    </div>
