<div class="space-y-6">
    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
            <flux:heading size="xl">{{ __('Edit Trainer') }}</flux:heading>
            <flux:subheading class="mt-1">{{ $trainer->user?->name }}</flux:subheading>
        </div>
        ...
        <div class="rounded-lg border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-800">
            ...
            <div class="mt-6">
                ...
                <div class="flex items-center gap-4">
                    <div class="h-16 w-16 overflow-hidden rounded-full bg-neutral-100 dark:bg-neutral-700">
                        @if ($photo)
